    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "DiarioEngenheiroSoftware", new DateTime(2020, 8, 26, 10, 8, 5, 510, DateTimeKind.Local).AddTicks(3383), "Lorem ipsum....", 5, new[] { "Engenharia de Software", "Design Patterns", "Programação" }, new byte[] {  }, "Padrões de Projeto e onde habitam" },
                    { 2, "DiarioEngenheiroSoftware", new DateTime(2020, 8, 26, 10, 8, 5, 512, DateTimeKind.Local).AddTicks(276), "Lorem ipsum....", 5, new[] { "Engenharia de Software", "Design Patterns", "Programação" }, new byte[] {  }, "Design Patterns #5: Adapter" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Luã Falcão", new DateTime(2020, 8, 26, 10, 8, 5, 513, DateTimeKind.Local).AddTicks(8226), "Comentário.......", "lpjfalcao@gmail.com" },
                    { 2, 2, "Luã Falcão", new DateTime(2020, 8, 26, 10, 8, 5, 514, DateTimeKind.Local).AddTicks(107), "Comentário.......", "lpjfalcao@gmail.com" }
                });
